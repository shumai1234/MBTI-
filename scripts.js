...
const classAttributes = {
    'SL': {
        ...
        description: `
            ...
            <div class="detail-section">
                ...
                <p>しかし、その愛情が深まるほど、相手のすべてを理解し、共有したいという欲求が強まります。相手があなたから離れていこうとする気配を感じ取ると、あなたは本能的な恐怖に駆られ、それを引き止めるために、時に相手の境界線を踏み越えてしまうことがあるでしょう。</p>
            </div>
            <div class="detail-section">
                ...
                <p>その圧倒的なエネルギーを「支配」ではなく、相手を「解き放つ」ために使えたとき、あなたは本当の意味で、人々に希望を与える不変の太陽になれるはずです。</p>
            </div>
        `
    },
    'SD': {
        ...
        description: `
            ...
            <div class="detail-section">
                ...
                <p>あなたは、集団の空気に惑わされることなく、自らの力で物事を貫き通す<strong>「不変の軸」</strong>の持ち主です。周囲に依存せず、独りで完結できる強靭な精神構造を持っており、他人に依存することはほとんどありません。</p>
                <p>「私が決めれば、道は開かれる」という静かな確信が、あなたの脳を常に最も効率的で鋭利な状態に保っています。</p>
            </div>
            <div class="detail-section">
                <h4>2. キャリアパス：領域を支配するスペシャリスト</h4>
                <p>独自の論理力と集中力で、誰も到達できないクオリティを叩き出す<strong>「卓越した革命家」</strong>としての資質があります。</p>
                <p>適職例： 専門職リーダー、戦略コンサルタント、高度技術者、クリエイティブディレクター。<br>馴れ合いを必要とせず、結果だけで周囲を黙らせる圧倒的な実力主義の世界で最も輝くでしょう。</p>
            </div>
            <div class="detail-section">
                <h4>3. 社会的役割：妥協なきクオリティの番人</h4>
                <p>社会におけるあなたの役割は、甘えや妥協を排除し、基準を極限まで引き上げる<strong>「改革の体現者」</strong>です。<br>組織の中にいても、あなたの魂は常に独立しており、全体が停滞した際に「あるべき姿」を冷徹かつ正確に提示します。あなたが独りで立ち、自らの道を行く背中は、多くの人に「真の自立」とは何かを教える、静かながらも強烈な影響力を持っています。</p>
            </div>
            <div class="detail-section">
                <h4>4. 恋愛・人間関係：沈黙を共有する深い信頼</h4>
                <p>馴れ合いや表面的なお世辞を嫌い、互いの領域を尊重し合える<strong>「自律的な関係」</strong>を重んじます。<br>恋愛が最優先事項になることは、ほとんどなく常に冷静な視点で、自分の人生の＋＠となる人を捜し求めています。</p>
            </div>
            <div class="detail-section">
                <h4>5. 意外な側面：光に潜む「影」の正体</h4>
                <p>あなたは非常に自立していて、孤独を味方につける唯一無二の強さを持っています。しかしその気高さは、時に意図せず、周囲との間に凍てつくような「絶壁」を作ってしまうこともあるでしょう。</p>
    ...
    'ML': {
        ...
        description: `
            <h3 class="detail-subtitle">「調和を育み、絆を守り抜く聖人」</h3>
            <div class="detail-section">
                <h4>1. 基本情報：世界を癒やす共鳴力</h4>
                <p>あなたは、周囲の感情の変化を誰よりも早く察知し、さざ波立つ場を平穏へと導く<strong>「静かなる癒やし手」</strong>です。自分を前面に出すことよりも、誰かの力になり、強い絆を育むことに最大の価値を見出します。</p>
            ...
            <div class="detail-section">
                ...
                <p>社会におけるあなたの役割は、バラバラな個人を一つの「家族」のような温かい共同体へと変える<strong>「結節点（ハブ）」</strong>です。<br>利己的な争いが絶えない世の中で、無償の献身を体現するあなたの姿は、人々に忘れていた信頼の尊さを思い出させます。あなたがそっと誰かの背中に手を添えるだけで、その人は救われ最大限の感謝をあなたに示してくれることでしょう。</p>
            </div>
            <div class="detail-section">
                <h4>4. 恋愛・人間関係：魂を包み込む無償の愛</h4>
                <p>相手の幸せを自分の喜びとして受け止めることができる、深く豊かな<strong>「愛の器」</strong>の持ち主です。<br>派手な自己主張はせずとも、相手の小さな変化に気づき、寄り添い続けるあなたの姿に、パートナーは究極の安らぎを感じます。あなたとの関係の中で、相手は「ありのままの自分でいいのだ」と感じられるでしょう。しかし世話焼きなあなたは、時に相手から依存されてしまったり、また、相手に浮気をされてしまうような悲しい経験を持っている人も多いでしょう。</p>
            </div>
            <div class="detail-section">
                <h4>5. 意外な側面：光に潜む「影」の正体</h4>
                <p>あなたは誰かを支え、愛を与えることで自らも輝く唯一無二の光を持っています。しかしその献身性は、時に意図せず、あなた自身の心をすり減らす大きな「影」を作り出してしまうことがあるでしょう。</p>
    ...
    'MD': {
        ...
        description: `
            ...
            <div class="detail-section">
                ...
                <p>あなたは、喧騒の中でも常に一歩引いた視点から世界を眺める、冷静沈着な<strong>「精神の自由人」</strong>です。何事にも過度に執着せず、淡々と事実を見つめるその姿勢は、周囲が感情に流される場面でも、あなただけは常に「真実」を見続けることを可能にしています。</p>
                <p>「私は常に自由であり、すべてを俯瞰している」という確信が、どんな難局でもパニックに陥らない強靭な知性を育んでいます。</p>
            </div>
            <div class="detail-section">
                <h4>2. キャリアパス：公平で無欲なバランサー</h4>
                <p>主観を排し、多角的な視点からリスクや最適解を導き出す<strong>「知的な防波堤」</strong>として、組織の安全を守ります。</p>
                <p>適職例： アナリスト、監査役、システムアーキテクト、研究者、危機管理スペシャリスト。<br>野心や権力争いから距離を置き、ただ「正しい解決策」を提示するあなたの存在は、混乱した組織における唯一の羅針盤となります。あなたが冷静に状況を分析し、一言を発するたびに、周囲の無駄な焦りは消え、物事は最も効率的なルートへと収束していきます。</p>
            </div>
            <div class="detail-section">
            ...
            <div class="detail-section">
                ...
                <p>独りの時間を尊び、相手の自由も尊重する、執着のない<strong>「広大な受容体」</strong>です。<br>一見すると淡白に映るかもしれませんが、その本質は「どんなあなたでも、ただそこにいていい」という究極の肯定にあります。束縛も干渉もしないあなたの隣は、安らぎを求める人にとって、誰にも邪魔されない最高の隠れ家となります。しかし、あなたは相手に依存されることを嫌い、また、相手に依存することもありません。そのため、相手から見ると、あなたは冷たく、無関心に見えてしまうこともあるかもしれません。ですが、その穏やかな恋愛観は、結婚生活に適しており、時間の経過とともに「言葉を超えた深い相互理解」へと熟成されていきます。</p>
                <p>しかし、あなたは相手に依存されることを嫌い、また、相手に依存することもありません。そのため、相手から見ると、あなたは冷たく、無関心に見えてしまうこともあるかもしれません。</p>
            </div>
            <div class="detail-section">
                <h4>5. 意外な側面：光に潜む「影」の正体</h4>
                <p>あなたは客観的な視点から物事を捉えることのできる温厚な精神を持っています。しかしその「現実的な視点」は、時に意図せず、絶好の機会から自分自身を遠ざけてしまうといった「影」を作ってしまうこともあります。</p>
                <p>それは、あなたの「執着のなさ」が、いつの間にか「他者への無関心」や「逃避」という仮面を被ってしまう時です。<br>波風を立てたくないという思いが強すぎるあまり、直視すべき問題や感情から目を背け、「自分には関係ない」と心のシャッターを下ろしてはいないでしょうか。一線を引くことで自分を守っているつもりが、気づけば誰の手も届かない深い孤独の深淵に、自ら沈み込んでしまうことがあるでしょう。</p>
            </div>
        `
    }
};
...
function shareOnX(resultType) {
    ...
    const hashtags = "16typePlusPlus,自己分析";
